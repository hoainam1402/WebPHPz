...
class Product
{
    ...
    {
        $db = new Db();
        $sql = "SELECT product_ID,product_Name,category_ID,decscription,category_Name,price,quantity,picture FROM product  INNER JOIN category where product.category_ID = category.cate_IDproduct_ID";
